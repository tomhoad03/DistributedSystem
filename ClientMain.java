...
public class ClientMain {
	...
	public static void testClient(int cport, int timeout, File downloadFolder) {
		...
		try {
			...
			try { client.store(new File("UploadFiles/test1.txt")); } catch(IOException e) { e.printStackTrace(); }

			try { client.store(new File("UploadFiles/test6.txt")); } catch(IOException e) { e.printStackTrace(); }
